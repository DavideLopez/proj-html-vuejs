                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="social-container">
                            <button class="square-btn" v-for="(social, i) in social" :key="i"><font-awesome-icon :icon="social.icon"></font-awesome-icon></button>
                        </div>
                    </div>
...
<script>
import LowFooter from './LowFooter.vue'

export default {
    name: "TheFooter",
    components: { LowFooter },
    data() {
        return {
            social: [
                {
